...
export function Contact() {
  return (
    <footer id="contact" className="relative w-full py-32 bg-gradient-to-br from-[#F5E2E3] via-[#ECCBC9] to-[#D0A0A3] text-slate-900 flex flex-col items-center overflow-hidden scroll-mt-24">
      {/* Background Grid */}
      <div
